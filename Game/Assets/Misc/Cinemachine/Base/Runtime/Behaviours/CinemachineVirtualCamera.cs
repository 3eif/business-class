...
namespace Cinemachine
{
    ...
    public class CinemachineVirtualCamera : CinemachineVirtualCameraBase
    {
        ...
        private static Transform getPlaneTransform(int index) {
            Transform t = null;
            switch (index) {
                case 0:
                    t = GameObject.Find("/mini plane").GetComponent<Transform>();
                    break;
                case 1:
                    t = GameObject.Find("/jet").GetComponent<Transform>();
                    break;
                case 2:
                    t = GameObject.Find("/commercial plane").GetComponent<Transform>();
                    break;
                case 3:
                    t = GameObject.Find("/spacecraft").GetComponent<Transform>();
                    break;
                case 4:
                    t = GameObject.Find("/paper plane").GetComponent<Transform>();
                    break;
            }
